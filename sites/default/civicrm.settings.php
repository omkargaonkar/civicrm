...
if (!defined('CIVICRM_UF_DSN') && CIVICRM_UF !== 'UnitTests') {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:password@localhost/civicrm?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:password@localhost:3306/civicrmsite?new_link=true');
  }
}
...
$civicrm_root = '/var/www/local.civicrm.com/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/local.civicrm.com/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://local.civicrm.com/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '77ca0ed5225cfd6f89181fa7876817c6');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/local.civicrm.com/sites/default/files/civicrm/templates_c//mail.log');
// }
